...
class MyWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setGeometry(200, 200, 4 * self.button_width, 9 * self.button_height)
        self.setWindowTitle("Kalkulator")
        self.initUI()

    def initUI(self):
        self.text_box = QLineEdit(self)
        self.text_box.move(0, self.button_height + 20)
        ...
        self.b_eq.setGeometry(3 * self.button_width, self.k + 5 * self.button_height, self.button_width,
                              self.button_height)
        self.b_eq.clicked.connect(self.clicked_button)
